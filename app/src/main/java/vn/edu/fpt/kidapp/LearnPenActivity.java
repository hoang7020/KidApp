...
public class LearnPenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_pen);
...
//            alert.show();
    ...
    public boolean isTrue() {
        if ((edt1.getText().toString() + edt2.getText().toString() + edt3.getText().toString()).equalsIgnoreCase("PEN"))
            return true;
